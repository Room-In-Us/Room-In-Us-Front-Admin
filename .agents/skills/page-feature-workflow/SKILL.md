...
3. Model loading, empty, error, disabled, and success states when the workflow needs them.
4. Keep API calls and query hooks out of presentational components.
5. Check responsive behavior for common admin widths.
